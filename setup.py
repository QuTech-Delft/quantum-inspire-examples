...
setup(name='quantum-inspire-examples',
      ...
      license='Apache 2.0',
      packages=[''],
      install_requires=['jupyter', 'projectq>=0.4', 'qiskit>=0.20.0', 'quantuminspire', 'boolean.py'],
      extras_require={
          'rtd': ['sphinx-rtd-theme', 'jupyter-sphinx', 'nbsphinx', 'sphinx-automodapi', 'sphinx-copybutton'],
      })
